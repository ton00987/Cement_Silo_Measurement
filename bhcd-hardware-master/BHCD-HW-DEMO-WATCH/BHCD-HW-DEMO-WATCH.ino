...
int pre_program_mode = 2;         // Pre program mode
...
const char *ssid = "Krittanat"; //ALIAS;   // SSID of WIFI CONNECTED
const char *password = "gumehotspot";  // Password of WIFI CONNECTED
