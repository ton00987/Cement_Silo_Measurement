...
//char ssid[] = "TonTon"; // your network SSID (name)
//char pass[] = "ton3003361"; // your network password
...
float VaPut[8] = {};
float VaGet[8] = {};
//float bmeTemperature[10] = {};
//float bmePressure[10] = {};
//float bmeAltitude[10] = {};
...
void readandprintbme() {
  ...
  for (int i = 0; i < AVG_SIZE; i++) {
    ...
    //  bmeVaPut[1] = bme.readPressure() / 100.0F;
